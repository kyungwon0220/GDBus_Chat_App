...
public:
    ...
    Q_INVOKABLE void userStopTyping();
...
signals:
    ...
    void userStopTypingFinished();
    void userStopTypingFailed(const QString &error_message);
    ...
    void userStoppedTypingSignal(const QString &user_name);
...
private:
    ...
    void onUserStopTypingFinish(const Glib::RefPtr<Gio::AsyncResult> &result);
    ...
    void onUserStoppedTyping(const Glib::ustring &user_name);
};
